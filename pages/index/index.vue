		...
		<el-container class="elcontainer">
		  <el-header class = "home-head">
			  ...
			  <div class = "workstation">
				  {{this.vuex_workstation==null?'':this.vuex_workstation.workstationName}}
			  </div>
			  ...
			  <el-dialog title="请指定工作站" :visible.sync="open" width="800px" append-to-body>
				  <el-tabs type="border-card" v-model="activeProcess" @tab-click="getWorkstationList">
					  <el-tab-pane v-for="item in processList" :key="item.processId" :label="item.processName" :name="item.processCode">
						  <el-card class="box-card" style="width: 300px" v-for="card in workstationList" :key="card.workstationId" :name="card.workstationCode">
							  <div slot="header">
								<span>工作站{{card.workstationCode}}</span>
								  <el-button type="primary" style="float:right;padding: 1px 0;" @click="setWorkstation(card)">选择</el-button>
							  </div>
